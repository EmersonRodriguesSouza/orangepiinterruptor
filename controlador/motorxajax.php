...
function controlazul() {
    ...
    if (!isset($estado22)) {
        $respuesta->alert("Não detectou a porta GPIO 22.");
...
function controlverde() {
    ...
    if (!isset($estado23)) {
        $respuesta->alert("Não detectou a porta GPIO 23.");
...
function controlrojo() {
    ...
    if (!isset($estado24)) {
        $respuesta->alert("Não detectou a porta GPIO 24.");
...
function controlamarillo() {
    ...
    if (!isset($estado25)) {
        $respuesta->alert("Não detectou a porta GPIO 25.");
